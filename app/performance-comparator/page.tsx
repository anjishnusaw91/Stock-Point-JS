...
export default function PerformanceComparatorPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Navbar 
        selectedTab="Performance Comparator" 
        setSelectedTab={handleTabChange}
        onLogout={handleLogout}
      />
      <main className="flex-grow p-0 md:p-4 mt-4">
        <Suspense fallback={<div className="p-4 text-center">Loading performance comparator...</div>}>
